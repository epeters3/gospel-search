...
from gospel_search.utils import batcher
from gospel_search.database.client import db
...
def write_segments(segments: t.List[Segment], batch_size: int) -> None:
    ...
    for segment in segments:
        db.segments.insert_one(segment.d)
    # TODO: batching
    # for batch in batcher(segments, batch_size):
    #     db.segments.insert_many([segment.d for segment in batch if segment is not None])
